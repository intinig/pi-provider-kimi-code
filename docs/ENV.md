...
| `KIMI_CODE_CUSTOM_HEADERS` | Newline-separated `Name: Value` headers added to model, file, usage, search, fetch, and datasource requests. Kimi identity, authorization, and per-request headers take precedence.                                                                                      |
